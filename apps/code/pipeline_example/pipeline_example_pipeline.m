...
function parameters = getGuiCaseParameters(ii, refValues)
    ...
    switch ii
        case 1
            ...
            parameters.hom_alpha = refValues(ii);
            parameters.density_std = 0.04;
            parameters.simuName = 'homogeneus_target_alpha0p55_std0p04';
            ...
            parameters.sound_speed_ref = 1595;
        ...
        case 2
            ...
            parameters.hom_alpha = refValues(ii);
            parameters.density_std = 0.04;
            parameters.simuName = 'homogeneus_target_alpha0p65_std0p04';
            parameters.source_f0 = 6660000;
            parameters.source_amp = 1000000;
            parameters.source_cycles = 3.5;
            parameters.source_focus = 0.04;
        ...
        case 3
            ...
            parameters.hom_alpha = refValues(ii);
            parameters.density_std = 0.04;
            parameters.simuName = 'homogeneus_target_alpha0p8_std0p04';
            parameters.source_f0 = 6660000;
            parameters.source_amp = 1000000;
            parameters.source_cycles = 3.5;
            parameters.source_focus = 0.04;
        ...
        case 4
            ...
            parameters.hom_alpha = refValues(ii);
            parameters.density_std = 0.04;
            parameters.simuName = 'homogeneus_target_alpha0p9_std0p04';
            parameters.source_f0 = 6660000;
            parameters.source_amp = 1000000;
            parameters.source_cycles = 3.5;
            parameters.source_focus = 0.04;
        ...
        case 5
            ...
            parameters.hom_alpha = refValues(ii);
            parameters.density_std = 0.04;
            parameters.simuName = 'homogeneus_ref_alpha0p5_std0p04';
            parameters.source_f0 = 6660000;
            parameters.source_amp = 1000000;
            parameters.source_cycles = 3.5;
            parameters.source_focus = 0.04;
